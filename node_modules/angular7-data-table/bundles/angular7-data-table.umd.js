(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/operators'), require('rxjs'), require('@angular/material/dialog'), require('ngx-popup-dialog'), require('@angular/cdk/a11y'), require('@angular/cdk/keycodes'), require('@angular/common'), require('@angular/forms'), require('@angular/material/button'), require('@angular/material/chips'), require('@angular/material/form-field'), require('@angular/material/icon'), require('@angular/material/input'), require('@angular/material/list'), require('@angular/material/select'), require('@angular/material/checkbox'), require('@angular/material/radio'), require('@angular/material/datepicker'), require('@angular/material/core')) :
	typeof define === 'function' && define.amd ? define('angular7-data-table', ['exports', '@angular/core', 'rxjs/operators', 'rxjs', '@angular/material/dialog', 'ngx-popup-dialog', '@angular/cdk/a11y', '@angular/cdk/keycodes', '@angular/common', '@angular/forms', '@angular/material/button', '@angular/material/chips', '@angular/material/form-field', '@angular/material/icon', '@angular/material/input', '@angular/material/list', '@angular/material/select', '@angular/material/checkbox', '@angular/material/radio', '@angular/material/datepicker', '@angular/material/core'], factory) :
	(factory((global['angular7-data-table'] = {}),global.ng.core,global.Rx.Observable.prototype,global.rxjs,global.ng.material.dialog,global.ngxPopupDialog,global.ng.cdk.a11y,global.ng.cdk.keycodes,global.ng.common,global.ng.forms,global.ng.material.button,global.ng.material.chips,global.ng.material['form-field'],global.ng.material.icon,global.ng.material.input,global.ng.material.list,global.ng.material.select,global.ng.material.checkbox,global.ng.material.radio,global.ng.material.datepicker,global.ng.material.core));
}(this, (function (exports,core,operators,rxjs,dialog,ngxPopupDialog,a11y,keycodes,common,forms,button,chips,formField,icon,input,list,select,checkbox,radio,datepicker,core$1) { 'use strict';
...
var DataTableComponent = /** @class */ (function () {
    function DataTableComponent() {
        ...
        this.filterAdded = new core.EventEmitter();
        this.filterRemoved = new core.EventEmitter();
        this.filterUpdated = new core.EventEmitter();
    ...
    DataTableComponent.prototype.ngOnInit = function () {
        ...
        this.subject$ = this.subject.pipe(operators.debounceTime(100)).subscribe((function () { return _this_1.reloadItems(); }));
    };
...
DataTableComponent.propDecorators = {
    ...
    filterableFields: [{ type: core.Input }],
    ...
    tableCssClass: [{ type: core.Input }],
    tableContainerCssClass: [{ type: core.Input }],
    ...
    filterAdded: [{ type: core.Output, args: ['filterAdded',] }],
    filterRemoved: [{ type: core.Output, args: ['filterRemoved',] }],
    filterUpdated: [{ type: core.Output, args: ['filterUpdated',] }],
...
var FieldFilterChooserPopupDialog = /** @class */ (function () {
    ...
    FieldFilterChooserPopupDialog.prototype.ngAfterViewInit = function () {
        this.keyboardEventsManager = new a11y.ListKeyManager(this.listItem);
    };
        ...
        if (this.keyboardEventsManager) {
            if (event.keyCode === keycodes.DOWN_ARROW || event.keyCode === keycodes.UP_ARROW) {
                ...
                if (activeItem == this.activeItem) {
                    event.keyCode === keycodes.DOWN_ARROW ? this.keyboardEventsManager.setFirstItemActive() : this.keyboardEventsManager.setLastItemActive();
...
FieldFilterChooserPopupDialog.ctorParameters = function () { return [
    { type: Function, decorators: [{ type: core.Inject, args: [ngxPopupDialog.POPUP_DIALOG_CLOSE,] }] },
    { type: undefined, decorators: [{ type: core.Inject, args: [dialog.MAT_DIALOG_DATA,] }] }
]; };
FieldFilterChooserPopupDialog.propDecorators = {
    listItem: [{ type: core.ViewChildren, args: ['listItem',] }]
};
...
FilterBarComponent.ctorParameters = function () { return [
    { type: DataTableComponent, decorators: [{ type: core.Inject, args: [core.forwardRef((function () { return DataTableComponent; })),] }] },
    { type: ngxPopupDialog.PopupDialogService }
]; };
...
DataTableModule.decorators = [
    { type: core.NgModule, args: [{
                ...
                imports: [
                    ...
                    forms.FormsModule,
                    {
                        ngModule: ngxPopupDialog.NgxPopupDialogModule,
                        providers: [ngxPopupDialog.PopupDialogService]
                    },
...
exports.ɵe = FieldFilterChooserPopupDialog;
exports.ɵf = FieldFilterPopupDialog;
exports.ɵd = FilterBarComponent;
...
//# sourceMappingURL=angular7-data-table.umd.js.map

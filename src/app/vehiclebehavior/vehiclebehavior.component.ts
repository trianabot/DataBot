...
@Component({
  selector: 'app-vehiclebehavior',
  templateUrl: './vehiclebehavior.component.html',
  styleUrls: ['./vehiclebehavior.component.css']
})
export class VehiclebehaviorComponent implements OnInit, OnDestroy {

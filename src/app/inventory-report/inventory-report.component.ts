  ...
  getStockaging(value, chartsdata) {
    this.stockagingchart = new Chart({
      ...
      series: [{
        name: value,
        data: [
          { name: '< 1month', y: chartsdata[0], color: '#CC6384' },
          { name: '1-6 month', y: chartsdata[1], color: '#686884' },
          { name: '6 month - 1 year', y: chartsdata[2], color: '#7DEED7' },
          { name: '> 1 year', y: chartsdata[3], color: '#88EE98' },
          // ['Year',5, ],
          // ['one month', 2],
          // ['Six Month', 7],
          // ['One Year', 9],
